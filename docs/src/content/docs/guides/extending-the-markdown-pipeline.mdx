...
**build-orchestration** plugin system (four hooks: `setup`, `preBuild`,
`postBuild`, `devMiddleware`) — it handles alias registration, virtual
modules, extra file emission, and dev-server routes. It does not
