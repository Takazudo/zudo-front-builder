...
See [`defineConfig`](/api/define-config) for the full shape.
...
See [Plugins](/concepts/plugins) for the full contract.
...
See the [Plugins](/concepts/plugins) page for the full `ZfbRouteManifest`
...
See [Customizing Markdown](/guides/customizing-markdown) for full details.
...
See [Syntax Highlighting](/guides/syntax-highlighting).
...
more specific, see
[Extending the Markdown Pipeline](/guides/extending-the-markdown-pipeline) for
