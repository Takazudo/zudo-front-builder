...
[CCResDoc](https://github.com/Takazudo/ccresdoc) is a working example: a Tauri
host spawns the native `zfb` binary on a loopback port and Rust generators
write MDX into its content tree.
