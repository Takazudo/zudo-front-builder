...
1. **Upgrade past it** once the next patch ships. That release goes out through the normal tag/release path with provenance restored, which clears the downgrade. This is the real fix.
