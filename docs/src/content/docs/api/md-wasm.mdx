...
| Subpath | gzip-9 wasm (2.10.0) | Exact runtime values | Exact type surface | Use when |
| --- | ---: | --- | --- | --- |
...
61,745 B (highlight), 89,198 B (render), and 48,568 B (parse) of headroom.
These are 2.10.0 measurements, not permanent promises — re-measure against
