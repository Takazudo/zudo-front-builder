...
the three-consumer bar — Mermaid diagrams, GitHub-style alerts, image
enlarge, link validation, transclusion, and eleven others — but are
...
See [Markdown Features](/markdown-features) for the full opt-in catalog
and [Extending the Markdown Pipeline](/guides/extending-the-markdown-pipeline)
...
- [Markdown Features](/markdown-features) — the opt-in extras catalog.
