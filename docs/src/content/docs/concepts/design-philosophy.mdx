...
handler cover patterns that are structurally inseparable from the build pipeline: things a consumer
...
- [Plugins](./plugins.mdx) — the narrow exception: the four lifecycle hooks
