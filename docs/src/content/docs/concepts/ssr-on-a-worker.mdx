...
asset. The [SSR and Cloudflare Bindings guide](../guides/ssr-and-cloudflare-bindings.mdx#importing-wasm-in-an-ssr-route)
has the Satori/Resvg setup, Wrangler rule, and package-size details.
