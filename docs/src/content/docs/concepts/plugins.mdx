...
These are unchanged from the v1 plugin contract.
...
Both hooks receive `{ projectRoot, outDir, config, options, logger }`. See [`ZfbBuildHookContext`](https://github.com/Takazudo/zudo-front-builder/blob/main/packages/zfb/src/plugins.ts) for the full shape.
