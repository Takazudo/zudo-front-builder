...
[SSR and Cloudflare Bindings](/guides/ssr-and-cloudflare-bindings#dev-prod-parity-for-prerender--false).
...
- [Islands](/concepts/islands) — how `"use client"` opts a component into the
  islands bundle
- [SSR and Cloudflare Bindings](/guides/ssr-and-cloudflare-bindings) — dev-side SSR
