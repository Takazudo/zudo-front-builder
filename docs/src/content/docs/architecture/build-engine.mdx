...
The host handler wins over any same-path runtime-SSR page — that is the whole point of the seam. See the [Embed-as-library guide](/guides/embed-as-library) for the builder shape, the handler signature, and the precedence contract in code.
