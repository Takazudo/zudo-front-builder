...
The compilation and surface contract are stable. See [MDX Components](/concepts/mdx-components) for the rendering side; the Rust↔JS bridge contract is an internal stable interface between the `zfb-content` crate and the page renderer.
