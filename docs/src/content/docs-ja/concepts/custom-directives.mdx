...
- **JSX コンポーネントを自動インポートすること。** コンポーネントを
  ...
  [MDX Components](/concepts/mdx-components) を参照してください。
...
- [MDX Components](/concepts/mdx-components) — コンパイル済みの MDX
  モジュールが要素レベルのオーバーライドをどう参照するか。
- [Engine vs Framework](/concepts/engine-vs-framework) — なぜ
