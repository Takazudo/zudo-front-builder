...
ハイドレーションも CSS 処理も Node を一切介さずに動きます。npm を使うプロジェクトにとって
組み込みの Tailwind が何を意味するかについては、
[Tailwind は zfb に組み込まれている](../concepts/styling.mdx#tailwind-v4-tailwind-は-zfb-に組み込まれている) を参照してください。
