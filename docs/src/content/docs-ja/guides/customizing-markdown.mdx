...
パイプラインが提供するものの全リスト — 常時オンの Core 機能、`zfb.config.ts` で有効化する Opt-in 機能、そして独自の visitor を in-tree で追加する方法 — については、[Markdown Features](../markdown-features/index.mdx) カテゴリを参照してください。
...
- [Markdown Features](../markdown-features/index.mdx) — Core と Opt-in
  機能の完全なカタログ。
