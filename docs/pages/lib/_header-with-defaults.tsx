...
// Host thin-stub — see @takazudo/zudo-doc/header-with-defaults.
// ThemeToggle is NOT imported from "@takazudo/zudo-doc/theme" — that barrel
// also re-exports DesignTokenTweakPanel and ColorTweakExportModal, which
// transitively pull react-dependent code into the zfb esbuild graph. The
// factory injects ThemeToggle as a dep instead (the dogfood pattern).
// See _head-with-defaults.tsx for the analogous ColorSchemeProvider note.
