...
export function SidebarWithDefaults(props: SidebarWithDefaultsProps): JSX.Element {
  ...
  const nodes = currentVersion ? remapVersionedHrefs(rawNodes, currentVersion, lang) : rawNodes;
  ...
  return Island({
    ...
    children: (
      <SidebarTree
        ...
        themeDefaultMode={settings.colorMode ? settings.colorMode.defaultMode : undefined}
      />
    ),
