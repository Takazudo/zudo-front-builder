// Thin stub — nav-source-docs moved to the package (docs-1.0-migration, S3).
...
const {
  ...
  getVersions: () => settings.versions || undefined,
  getLocaleConfig: (lang: string) => settings.locales[lang],
  loadCategoryMeta,
  isNavVisible,
