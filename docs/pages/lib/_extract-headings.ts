// Thin showcase wrapper around @takazudo/zudo-doc/extract-headings (docs-1.0-migration, S3).
...
// passes them through so call sites in the doc-route paths() functions continue
// to call extractHeadings(body) without change.
