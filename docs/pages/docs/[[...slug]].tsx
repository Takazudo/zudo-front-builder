...
// built by the shared, memoized buildDocRouteEntries; rendering by the shared
// renderDocPage. This file owns only the route's nav source and the
// param/prop shapes — the host keeps the route so it renders the host-only
// MDX showcase components and chrome.
