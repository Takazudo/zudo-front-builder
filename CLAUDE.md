...
Audited and retagged in full during issue #1337 (2026-07); reconciled again during issue #1504 (2026-07); a third cross-pipeline env-gate joined during issue #1674 (2026-07). The table below lists all **32** ignored Rust tests (**26** `env-gate`, **5** `heavy`, **1** `verification`) and their scheduled homes. Update this table whenever a `#[ignore]` is added, removed, or reclassified.
