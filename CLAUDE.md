...
Audited and retagged in full during issue #1337 (2026-07); reconciled again during issue #1504 (2026-07). The table below lists all **30** ignored Rust tests (**24** `env-gate`, **5** `heavy`, **1** `verification`) and their scheduled homes. Update this table whenever a `#[ignore]` is added, removed, or reclassified.
